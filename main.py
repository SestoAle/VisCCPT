...
class WorlModelCanvas(QObject, scene.SceneCanvas):
    ...
    def load_data(self, model_name):
        ...
        if self.trajectory_visualizer:
            ...
            try:
                ...
                print("To print the demonstrations, you have to provide the demonstrations file")
    ...
    def load_motivation(self, model_name):
        try:
            ...
            raise Exception(".ini file is not present. You must provide a .ini file with all the details in the"
                            "arrays folder. Some pre-made examples of .ini files are in the arrays folder.")
